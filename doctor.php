...
<html lang="en-US">
   ...
   <body style='background-image:url(doct4.jpg)'>
   
<h1 style='margin-top:30px;text-align:center;'><b>Patient Info</b></h1>
      <div class="container">
         <div class="card">
            <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Patient</strong> <a href="manage-users.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Patient</a></div>
         </div>
         <hr>
         <div>
